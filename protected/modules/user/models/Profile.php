...
class Profile extends UActiveRecord
{
	...
	public function rules()
	{
		if (!self::$_rules) {
			...
			array_push($rules,array("email", 'safe'));
			self::$_rules = $rules;
		}
		return self::$_rules;
	}
	...
	public function attributeLabels()
	{
		return array(
                    ...
                    "TelephoneNo" => "Numer telefonu",
                    "WorkPlace" => "Szkoła / Praca",
                    "Notes" => "Uwagi",
                    "PlaceOfBirth" => "Miejsce urodzenia",
                    "IsStudent" => "Typ",
                    "DateOfBirth" => "Data urodzenia w formacie rrrr-mm-dd",
                    "TelephoneGuardian" => "Numer telefonu opiekuna",
                    "EmailGuardian" => "Email opiekuna",
                    "IncomePerPerson" => "Dochoòd na osobę",
                    "NoOfPeopleInHousehold" => "Ilość osób w gospodarstwie",
                    "AverageIncome" => "Średni dochód na osobę",
